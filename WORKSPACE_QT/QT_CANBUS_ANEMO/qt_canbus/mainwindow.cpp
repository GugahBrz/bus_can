    ...
    ui(new Ui::MainWindow)
{
    ...
    label_to_send->setText("Mesure du vent");
    //QLabel *label_received = new QLabel;
    //label_received->setText("VL6180x");

    //Mesures Capteur MPU9520
    QLabel *anemo_received = new QLabel;
    anemo_received->setText("Vitesse du vent:");
    ...
    m_layout->addWidget(anemo_received,2,1);
...
void MainWindow::receiveCANMessage()
{
    ...
    short Vitesse = ((short)pMsgBuff.Msg.DATA[1] << 8) | (short)pMsgBuff.Msg.DATA[0];


    mesure_box_0->setText(QString::number(Vitesse));
