...
//=============================================================================================
MainWindow_opengl::MainWindow_opengl(QWidget *parent,int w, int h)
    : QMainWindow(parent)
{        
    // Set the window size
    this->resize(w,h);
...
//=============================================================================================
void MainWindow_opengl::resizeEvent(QResizeEvent *)
{
...
//=============================================================================================
void MainWindow_opengl::onTimer_UpdateDisplay()
{
    Object_GL->updateGL();
}
//=============================================================================================
...
void MainWindow_opengl::openCANPort()
{
...
//===============================================================
void MainWindow_opengl::receiveCANMessage()
{
...
void MainWindow_opengl::onTimer_Tick()
{
receiveCANMessage();
}
